...
<head>
    ...
    <@mcf.head />
    <style>
        .simditor { width:730px; margin-left: 160px; margin-top: -20px; min-height: 100px;  }
        .simditor .simditor-toolbar>ul>li>.toolbar-item { width: 36px;height: 30px;line-height: 30px; }
        .simditor .simditor-toolbar>ul>li { margin: -10px 0 0 0;}
    </style>
</head>
<body>
<@mcf.header />
<div class="cz-wrap">
    ...
    <form id="form1" name="form1" action="<@mcf.ctx />/u/post-add" method="post">
        <div>
            <ul class="cz-post">
                <li><label for="title">标题</label><input id="title" name="title"></li>
                <li>
                    <label for="perfix_id">主题</label><@mcf.topicChoose />
                </li>
                <li>
                    <label for="valicode">分类</label><@mcf.classChoose />
                </li>
                ...
                <li><label for="refphone">获得折扣方法</label><textarea id="refphone" name="refphone" style="vertical-align: top"></textarea></li>
