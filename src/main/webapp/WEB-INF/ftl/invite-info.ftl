...
<div class="cz-wrap">
    ...
    <div class="pull-right cz-content">
        <h2>我邀请的人<span class="pull-right">为了维护圈子的和谐,不认识的人请不要审核通过哦~</span></h2>
        ...
        <#list inviteList as item>
            <tr>
                ...
                <td align="left">
                    <a href="<@mcf.ctx/>/u/invite-commit/${item.id}/pass" class="cz-btn btn-success">通过</a><a href="<@mcf.ctx/>/u/invite-commit/${item.id}/nopass" class="cz-btn">不认识</a>
                </td>
            </tr>
        </#list>
        </table>
